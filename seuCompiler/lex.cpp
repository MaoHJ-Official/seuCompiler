...
void Lex::scanner()
{
    ...
    while (!cin.eof())
    {
        ...
        case 3:
        {
            ...
            {
                state = 4;
                cout << "string yylex();" << endl;//声明lex函数
...
void Lex::outCodeLeft()
{
    ...
    cout << "//扫描函数" << endl;
    cout << "string LEX_scanner(char *str)" << endl;
    cout << "{" << endl;
    cout << "    char ch = ' ';" << endl;
...
void Lex::outCodeRight()
{
    ...
    cout << "}" << endl;
    cout << endl;
    cout << "string yylex()" << endl;
    cout << "{" << endl;
    cout << "   string thelex=\"NULL\";" << endl;
    /*
    FILE* file;
    errno_t err;
    ...
    */
    ...
    cout << "    {" << endl;
    cout << "        ++LEX_LINE;" << endl;
    cout << "        thelex=LEX_scanner(LEX_BUFF);" << endl;
    cout << "    }" << endl;
    cout << "    fclose(file);" << endl;
    cout << "    return thelex;" << endl;
    cout << "}" << endl;
}
